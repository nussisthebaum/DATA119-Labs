...
question(
  ...
  allow_retry = TRUE, 
  post_message = "Correct! These are ALL nodes."
)
```
...
```{python name, exercise = TRUE, exercise.eval = FALSE}
        ...name = ...
```
...
Now, write code that will count the number of cities in a larger tree. 
