...
# To download this file go to https://posit.ds.uchicago.edu/data119reviewlab/www/msleep.csv
...
question(
  ...
  answer("$k$NN",  message = "Not quite. $k$NN ($k$ Nearest Neighbors) is a classification algorithm which does not allow us to model continuous response variables."),
...
question_checkbox(
  ...
  answer("$k$NN",correct = TRUE,  message = "Correct! $k$NN ($k$ Nearest Neighbors) is a classification algorithm which allows us to model binary response variables."),
...
Try running $k$NN with different numbers of neighbors. Plot the training and the testing accuracy across different values of $k$.
...
(p9.ggplot(kNN_plot, p9.aes(x=___, y=___, color=___)) +
    ...
    p9.scale_y_continuous(name="Accuracy")).show()
```
