...
```{r q22, echo=FALSE}
question("22. What threshold will result in an accuracy equal to the proportion of true positives in the data?",
...
```{r q23, echo=FALSE}
question("23. What threshold will result in an accuracy equal to the proportion of true negatives in the data?",
         answer("0"),
         answer("1", correct = TRUE),
         answer("There is no way to tell.", message = "Use the confusion matrix function to confirm for yourself!"),
         allow_retry = TRUE
