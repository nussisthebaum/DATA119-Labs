...
htmltools::tagList(
  htmltools::tags$div(
    ...
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/good_fit_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-linearity_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/heteroscedasticity_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-normal_residuals_residual_plot.png", height = "100"),
...
htmltools::tagList(
  htmltools::tags$div(
    style = "display: flex; gap: 20px;",
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/high_leverage_points_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/large_residuals_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/both_high_leverage_&_large_residuals_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/clustered_outliers_residual_plot.png", height = "100"),
      htmltools::tags$figcaption("Plot D")
    )
  )
)
