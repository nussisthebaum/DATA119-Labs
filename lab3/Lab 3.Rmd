...
correct_answers_outlier <- list(
  leverage = HTML('<img src="./images/high_leverage_points_residual_plot.png" height="80">'),
  residuals = HTML('<img src="./images/large_residuals_residual_plot.png" height="80">'),
  both = HTML('<img src="./images/both_high_leverage_&_large_residuals_residual_plot.png" height="80">'),
  cluster = HTML('<img src="./images/clustered_outliers_residual_plot.png" height="80">')
)
...
observeEvent(input$submit_resid, {
  result <- all(
    identical(input$good, list(correct_answers_resid$good)),
    identical(input$nonlinear, list(correct_answers_resid$nonlinear)),
    identical(input$hetero, list(correct_answers_resid$hetero)),
    identical(input$non_normal, list(correct_answers_resid$non_normal))
  )
