...
5. Match each plot to the regression issue it most clearly illustrates:

```{r q5, echo = FALSE}
htmltools::tags$div(
    style = "display: flex; flex-wrap: wrap; gap: 20px;",
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/good_fit_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-linearity_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/heteroscedasticity_residual_plot_updated.png", height = "120"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-normal_residuals_residual_plot.png", height = "120"),
...
question_match(
    ...
    answer = c(
      "Good Fit (no violations)",
      "Non-Linearity",
      "Heteroscedasticity",
      "Non-Normal Residuals"
    ),
    correct = list(
      "Plot A" = "Good Fit (no violations)",
      "Plot B" = "Non-Linearity",
      "Plot C" = "Heteroscedasticity",
      "Plot D" = "Non-Normal Residuals"
    ),
    feedback = "Refer to each residual pattern's shape and spread.",
    shuffle = TRUE,
    allow_retry = TRUE
)
```
...
htmltools::tagList(
  htmltools::tags$div(
    style = "display: flex; flex-wrap: wrap; gap: 20px;",
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/high_leverage_points_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/large_residuals_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/both_high_leverage_&_large_residuals_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/clustered_outliers_residual_plot.png", height = "120"),
      htmltools::tags$figcaption("Plot D")
    )
  ),
