...
question(
  ...
  list(
    good = htmltools::HTML('<img src="good_fit_residual_plot.png" height="100">'),
    nonlinear = htmltools::HTML('<img src="non-linearity_residual_plot.png" height="100">'),
    hetero = htmltools::HTML('<img src="heteroscedasticity_residual_plot.png" height="100">'),
    non_normal = htmltools::HTML('<img src="non-normal_residuals_residual_plot.png" height="100">')
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
...
question(
  ...
  list(
    leverage = htmltools::HTML('<img src="high_leverage_points_residual_plot.png" height="100">'),
    residuals = htmltools::HTML('<img src="large_residuals_residual_plot.png" height="100">'),
    both = htmltools::HTML('<img src="both_high_leverage_&_large_residuals_residual_plot.png" height="100">'),
    cluster = htmltools::HTML('<img src="clustered_outliers_residual_plot.png" height="100">')
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
...
question_checkbox(
  HTML("
    ...
    <img src='non_normal_large_outliers_residual_plot.png' height='200px'>
  "),
  type = "multiple",
...
question_checkbox(
  HTML("8. Which issues are present in this residual plot shown?<br><br>
    <img src='exponential_combo_residual_plot.png' height='200px'>"),
