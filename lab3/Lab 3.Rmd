...
htmltools::tags$div(
    ...
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/heteroscedasticity_residual_plot_updated.png", height = "200"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-linearity_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/good_fit_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/non-normal_residuals_residual_plot.png", height = "200"),
