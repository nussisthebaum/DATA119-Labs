---
title: "Lab 3: Assumption Checking and Multiple Linear Regression"
...
```{python diagnostic_plots_log, exercise=TRUE, message = FALSE, exercise.setup="setup4"}
