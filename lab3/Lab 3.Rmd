...
question(
  "Match each letter to its position in the alphabet:",
  type = "matching",
  list(
    "A" = "1",
    "B" = "2",
...
question(
  "6. Match each residual plot to the type of outlier it demonstrates:",
  type = "matching",
  list(
...
question_checkbox(
  HTML("8. Which issues are present in this residual plot shown?<br><br>
    <img src='./images/exponential_combo_residual_plot.png' height='200px'>"),
