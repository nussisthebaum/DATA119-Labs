...
question(
  ...
  list(
    answer("Good Fit", value = "good", label = HTML('<img src="./images/good_fit_residual_plot.png" height="100">')),
    answer("Non-Linearity", value = "nonlinear", label = HTML('<img src="./images/non-linearity_residual_plot.png" height="100">')),
    answer("Heteroscedasticity", value = "hetero", label = HTML('<img src="./images/heteroscedasticity_residual_plot.png" height="100">')),
    answer("Non-Normal", value = "non_normal", label = HTML('<img src="./images/non-normal_residuals_residual_plot.png" height="100">'))
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
...
```{r q6, echo = FALSE}
question(
  "6. Match the type of outlier to its corresponding plot:",
  type = "matching",
  list(
  ...
  list(
    answer("High Leverage", value = "leverage", label = HTML('<img src="./images/high_leverage_points_residual_plot.png" height="100">')),
    answer("Large Residuals", value = "residuals", label = HTML('<img src="./images/large_residuals_residual_plot.png" height="100">')),
    answer("Both", value = "both", label = HTML('<img src="./images/both_high_leverage_&_large_residuals_residual_plot.png" height="100">')),
    answer("Clustered", value = "cluster", label = HTML('<img src="./images/clustered_outliers_residual_plot.png" height="100">'))
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
