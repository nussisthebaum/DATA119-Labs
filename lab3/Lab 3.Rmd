...
```{r q5, echo = FALSE}
question(
  "5. Match each residual plot to the issue it demonstrates:",
  type = "matching",
  list(
    htmltools::HTML('<img src="./images/good_fit_residual_plot.png" height="100">') = "Good Fit (no violations)",
    htmltools::HTML('<img src="./images/non-linearity_residual_plot.png" height="100">') = "Non-Linearity",
    htmltools::HTML('<img src="./images/heteroscedasticity_residual_plot.png" height="100">') = "Heteroscedasticity",
    htmltools::HTML('<img src="./images/non-normal_residuals_residual_plot.png" height="100">') = "Non-Normal Residuals"
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
...
```{r q6, echo = FALSE}
question(
  "6. Match each residual plot to the type of outlier it represents:",
  type = "matching",
  list(
    htmltools::HTML('<img src="./images/high_leverage_points_residual_plot.png" height="100">') = "High Leverage Points",
    htmltools::HTML('<img src="./images/large_residuals_residual_plot.png" height="100">') = "Large Residuals",
    htmltools::HTML('<img src="./images/both_high_leverage_&_large_residuals_residual_plot.png" height="100">') = "High Leverage + Large Residuals",
    htmltools::HTML('<img src="./images/clustered_outliers_residual_plot.png" height="100">') = "Clustered Outliers"
  ),
  correct = TRUE,
  allow_retry = TRUE,
  random_answer_order = TRUE
