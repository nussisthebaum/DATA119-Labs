...
```{r q5, echo = FALSE}
bucket_list_ui <- bucket_list(
  header = "5. Match each plot to the regression issue it most clearly illustrates:",
  group_name = "residuals",
  orientation = "vertical",
  add_rank_list(
    text = "Plots:",
    labels = list(
      HTML('<img src="./images/good_fit_residual_plot.png" height="80">'),
      HTML('<img src="./images/non-linearity_residual_plot.png" height="80">'),
      HTML('<img src="./images/heteroscedasticity_residual_plot_updated.png" height="80">'),
      HTML('<img src="./images/non-normal_residuals_residual_plot.png" height="80">')
    ),
    input_id = "unsorted"
  ),
...
# Correct answers as HTML strings
correct_answers <- list(
  good = HTML('<img src="./images/good_fit_residual_plot.png" height="80">'),
  nonlinear = HTML('<img src="./images/non-linearity_residual_plot.png" height="80">'),
  hetero = HTML('<img src="./images/heteroscedasticity_residual_plot_updated.png" height="80">'),
  non_normal = HTML('<img src="./images/non-normal_residuals_residual_plot.png" height="80">')
)
...
server <- function(input, output, session) {
  observeEvent(input$submit, {
    result <- all(
      identical(input$good, list(correct_answers$good)),
      identical(input$nonlinear, list(correct_answers$nonlinear)),
      identical(input$hetero, list(correct_answers$hetero)),
      identical(input$non_normal, list(correct_answers$non_normal))
    )
...
htmltools::tags$div(
    ...
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/high_leverage_points_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot A")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/large_residuals_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot B")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/both_high_leverage_&_large_residuals_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot C")
    ),
    htmltools::tags$figure(
      htmltools::tags$img(src = "./images/clustered_outliers_residual_plot.png", height = "200"),
      htmltools::tags$figcaption("Plot D")
    )
)

gradethis::question_match(
    prompt = c("Plot A", "Plot B", "Plot C", "Plot D"),
    answer = c(
      "High Leverage Points",
      "Large Residuals",
      "High Leverage + Large Residuals",
      "Clustered Outliers"
    ),
    correct = list(
      "Plot A" = "High Leverage Points",
      "Plot B" = "Large Residuals",
      "Plot C" = "High Leverage + Large Residuals",
      "Plot D" = "Clustered Outliers"
    ),
    feedback = "Pay attention to extreme values and where they occur.",
    shuffle = TRUE,
    allow_retry = TRUE
)
