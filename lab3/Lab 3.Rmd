...
plot_labels_resid <- list(
  "Plot A" = HTML('<img src="./images/good_fit_residual_plot.png" height="150">'),
  "Plot B" = HTML('<img src="./images/non-linearity_residual_plot.png" height="150">'),
  "Plot C" = HTML('<img src="./images/heteroscedasticity_residual_plot_updated.png" height="150">'),
  "Plot D" = HTML('<img src="./images/non-normal_residuals_residual_plot.png" height="150">')
)
