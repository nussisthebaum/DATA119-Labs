...
# To download this file go to https://posit.ds.uchicago.edu/regularizationlab/www/Workinghours_mini.csv
...
4.Take some time to really explore this dataset. Look at summary statistics and distributions of each of the variables. Note that there is no solution for this exercise, you can do whatever you think is necessary to explore!
...
Some of you will have noticed that the colors are difficult to parse! I like to put labels on my graphs, but that isn't strictly necessary--if you do want to do it, check out the documentation for [`geom_label()`](https://plotnine.org/reference/geom_label.html). You will also have to explore the `inherit_aes` option.
