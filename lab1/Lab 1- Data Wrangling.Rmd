...
grade_this({
  if (identical(epicurious_num, epicurious[['title', 'rating', 'calories', 'protein', 'fat', 'sodium']])) {
    pass("Secrets")
  }
  fail()
})
...
question_numeric(text = "What percent of `protein` is missing?",
