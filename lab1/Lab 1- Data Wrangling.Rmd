...
header-includes:
  - <link href="http://fonts.googleapis.com/css2?family=EB+Garamond&display=swap" rel="stylesheet">
  - <link href="http://fonts.googleapis.com/css2?family=Space+Mono&display=swap" rel="stylesheet">
---
...
tags$div(
  ...
  tags$div(
    ...
    tags$h1("Data Cleaning and Visualization", class = "pageTitle")
  )
)
```
