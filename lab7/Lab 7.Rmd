...
```{r q7check, echo = FALSE}
q7_correct <- tutorial_question_state("q7")$correct
```

```{r table_intro_text, echo=FALSE, results='asis', eval=q7_correct}
cat("Your answers from Question 7 can be fed into the following table (in red):")
```

```{r conditional_table, echo=FALSE, eval=q7_correct}
library(kableExtra)
