...
q7_correct <- get_tutorial_state("q7")$correct
```

```{r conditional_atble, echo=FALSE, eval=TRUE}
...
q7_correct_poll <- reactivePoll(500, session,
  checkFunc = function() get_tutorial_state()$questions$q7$correct,
  valueFunc = function() get_tutorial_state()$questions$q7$correct
)
