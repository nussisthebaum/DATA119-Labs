...
Your answers from Question 7 can be fed into the following table (in red):
...
```{r q8, echo=FALSE}
question(
  "8. Based on this table, will Clusters 1 and 2 be merged at the next step of the algorithm?",
...
kmeans2 = KMeans(n_clusters = ..., n_init = 5)
...
```{python setup7, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup3"}
from sklearn.cluster import KMeans
...
```{r q30, echo=FALSE}
question("30. Which cluster(s) contain mostly fish/meat recipes?",
         answer("`0.0`"),
...
```{python complete, exercise = TRUE, message = FALSE, exercise.setup="setup3"}
...
```{python setup8, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup3"}
from sklearn.cluster import AgglomerativeClustering
...
```{python labels2, exercise = TRUE, message = FALSE, exercise.setup="setup8"}
...
```{python setup9, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup8"}
from matplotlib import pyplot as plt
from scipy.cluster.hierarchy import dendrogram
...
```{python, smalldendro, exercise = TRUE, message = FALSE, exercise.setup="setup9"}
...
```{python scipy, exercise = TRUE, message = FALSE, exercise.setup="setup3"}
from scipy.cluster.hierarchy import dendrogram, linkage, fcluster
```

```{python setup10, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup3"}
from scipy.cluster.hierarchy import dendrogram, linkage, fcluster
...
```{python sp_linkage, exercise = TRUE, message = FALSE, exercise.setup="setup10"}
...
```{python setup11, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup10"}
l_epi = linkage(epi_tiny, method='complete')
```

```{python sp_dendro1, exercise = TRUE, message = FALSE, exercise.setup="setup11"}
dendrogram(..., ..., above_threshold_color='k')
```
...
```{python sp_dendro2, exercise = TRUE, message = FALSE, exercise.setup="setup11"}
