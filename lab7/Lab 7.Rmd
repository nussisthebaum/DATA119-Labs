...
```{r q30, echo=FALSE}
question("30. Which cluster(s) contain mostly meat recipes?",
...
```{r q31, echo=FALSE}
question("31. Which cluster(s) contain mostly vegetarian recipes?",
         answer("`0.0`"),
...
```{r q33, echo=FALSE}
question("33. Which cluster(s) contain mostly cocktails?",
         answer("`0.0`"),
         answer("`1.0`"),
         answer("`2.0`"),
...
37. Another option would be to take a smaller random sample of the observations:
...
```{python scipy, exercise = TRUE, message = FALSE, exercise.setup="setup9"}
from scipy.cluster.hierarchy import dendrogram, linkage, fcluster
```

```{python setup10, exercise = FALSE, echo=FALSE, message = FALSE, exercise.setup="setup9"}
from scipy.cluster.hierarchy import dendrogram, linkage, fcluster
```
