...
import sklearn.linear_model import LinearRegression, Ridge, RidgeCV, Lasso, LassoCV
...
```{python onei, exercise = TRUE, message = FALSE}
temp_model = ...
...
temp_model = sklearn.linear_model.RidgeCV(alphas = alphas_r[0]).fit(X_train_pp, y_train)
