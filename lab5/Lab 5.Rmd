...
py_install(c('pandas', 'numpy', 'plotnine', 'scikit-learn')) 
...
Workinghours = pd.read_csv("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/main/Workinghours_mini.csv", index_col = 0)
```
