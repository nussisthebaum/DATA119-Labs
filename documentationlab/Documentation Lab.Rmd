...
**Note:**
:::
We tend to use the `pyplot` portion of `matplotlib` often, so I specifically import that section and give it the abbreviation `plt`. But, you should be aware that you do not have to load `matplotlib` in this way. You could also run `import matplotlib` or `import matplotlib as mpl` etc.
:::
