...
custom_checker <- function(label, user_code, solution_code, envir_result, evaluate_result, last_value, stage, ...) {
  if (stage == "code_check") {
      # Convert Python objects to strings for comparison
      if (identical(as.character(user_code), as.character(solution_code))) {
...
question("4. Predict the class for point J, based on its three nearest neighbors.",
         ...
         answer("Blue Triangle (Class 2)", correct=TRUE, message="Point H is Class 1 (red circles), but points A and B are Class 2 (blue triangles). Since two of the three neighboring points are Class 2, we would predict point J to also be Class 2."), 
         allow_retry = TRUE
)
```
...
confusion_matrix <- matrix(c(2, 2, 4, 5), nrow = 2, byrow = TRUE)
...
question("11. Would increasing the number of neighbors to 5 affect the training set accuracy of the classifier?",
         ...
         answer("False"), 
         allow_retry = TRUE, 
         post_message = "Congratulations! You have found the third secret word: MARBLE."
)
```
...
```{r q22, echo=FALSE}
question("22. What is the best $k$?",
         answer("1"),
         answer("3"),
         answer("5", correct=TRUE),
         answer("10"),
