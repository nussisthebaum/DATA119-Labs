...
```{bash ex4, exercise = TRUE, exercise.setup = "setup-directory2"}
...
Once you are done with the murder mystery, remember that you can download the files for yourself and "resolve" on your own computer to get used to the command line interface!
