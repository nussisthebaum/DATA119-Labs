...
tags$script(HTML("
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var bandContent = document.querySelector('.bandContent.page');
    if (topContainer && bandContent) {
      bandContent.insertBefore(topContainer, bandContent.firstChild);
    }
  });
"))
```
