...
gasprice = pd.read_csv("./www/gasprice.csv")
eagles = pd.read_csv("./www/eagles.csv")

epicurious_nd = pd.read_csv("./www/epi_mini_clean.csv")
```
...
question("5. Is a linear relationship appropriate for describing the relationship between time and price? If not, what type of relationship might be more appropriate?",
         ...
         allow_retry = TRUE, 
         post_message = "Congratulations! You have found the second secret word: COMMISSION.")
```
...
```{python stats, exercise = TRUE, message = FALSE, exercise.setup="min"}
