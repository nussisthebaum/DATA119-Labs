...
tags$style(HTML("
  ...
  .topContainer img.topLogo {
    max-height: 100px;
    width: auto;
    margin-bottom: 10px;
  }
  .topContainer h1.pageTitle {
    margin: 0;
    font-size: 2.5rem;
  }
  .resetButton {
...
tags$div(
  class = "topContainer",
  tags$img(
    src = "./UChicago_DataScienceInstitute_Vertical_White RGB.svg",
    alt = "DSI Logo",
    class = "topLogo"
  ),
  tags$h1("Welcome to DATA119 - Lab 2", class = "pageTitle"),
  tags$h1("Correlation and Simple Linear Regression")
)
```
