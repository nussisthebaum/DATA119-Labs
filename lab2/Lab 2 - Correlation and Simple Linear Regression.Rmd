...
tags$div(
  ...
  tags$div(
    class = "logoAndTitle",
    tags$img(
      src = url("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/refs/heads/dev_aj/dsi_logo.png"),
      alt = "DSI Logo",
      class = "topLogo"
    ),
...
tags$script(HTML("
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var bandContent = document.querySelector('.pageContent.band');
    if (topContainer && pageContent) {
      pageContent.insertBefore(topContainer, pageContent.firstChild);
    }
  });
"))
```
