...
output: 
  learnr::tutorial:
    theme: !expr bslib::bs_theme(
        bg = "white", fg = "black", primary = "#800000",
        secondary = "#737373", info = "#A6A6A6",
...
tags$div(
  ...
  tags$div(
    class = "logoAndTitle",
    tags$img(
      src = "https://chicagoparent.nyc3.cdn.digitaloceanspaces.com/wp-content/uploads/2021/01/adobestock_69580798.jpeghttps://www.marthastewart.com/thmb/yhgiLuSTcFaN1WbwUua_W9SMHws=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/prettiest-flowers-painted-tongue-flower-lead-getty-1123-00763085ad384a9b9bf1f5cc81bee390.jpg",
      alt = "DSI Logo",
      class = "topLogo"
    ),
...
```{python setup1, exercise=TRUE, exercise.eval = FALSE, engine = "python"}
import numpy as np
import pandas as pd
import plotnine as p9

mtcars = pd.read_csv("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/refs/heads/main/data/mtcars.csv")
gasprice = pd.read_csv("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/refs/heads/main/data/gasprice.csv")
eagles = pd.read_csv("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/refs/heads/main/data/eagles.csv")

epicurious_nd = pd.read_csv("https://raw.githubusercontent.com/nussisthebaum/DATA119-Labs/refs/heads/main/data/epi_mini_clean.csv")
```
