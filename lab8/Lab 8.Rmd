...
#goodreads_nussbaum <- read.csv("goodreads_nussbaum.csv")
...
#goodreads_jotte <- read.csv("goodreads_jotte.csv")
...
#locations <- read.csv("/Users/amynussbaum/Documents/U of C/Courses/119/2023 Spring/Week 8/Lab/locations.csv", row.names = 1)
...
```{sql goodreadsfinal, exercise = TRUE, connection = "db_con", exercise.setup = "setup1"}
...
```{r setup_homework, exercise = FALSE, echo=FALSE, message = FALSE}
...
```{sql homework, exercise = TRUE, connection = "db_con", exercise.setup = "setup_homework"}
