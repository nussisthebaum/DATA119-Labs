...
gradethis_setup()
tutorial_options(exercise.completion = FALSE, exercise.timelimit = 180)
```
...
```{r bern2-check, message = FALSE, warning = FALSE}
grade_result({
  pass_if(~ all.equal(reticulate::py_to_r(.result), 0.58*0.58*0.58, tolerance = 0.0001))
})
```
