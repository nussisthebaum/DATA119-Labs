...
```{python a1_qty, exercise=TRUE, message=FALSE, exercise.setup="a1_step1_pat"}
qty = ___
...
```{python a2_names, exercise=TRUE, message=FALSE, exercise.setup="a2_step1_pat"}
names = ___
names
```
...
```{python a4_sub, exercise=TRUE, message=FALSE, exercise.setup="a4_step1_pat"}
redacted = ___
redacted
```
...
```{python d1_parse3, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
...
```{python d1_parse4, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
soup.find_all("span")
```
...
```{python d1_parse6, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
...
```{python d1_parse7, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
...
```{python d1_parse8, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
products[0].get_text()
```
...
```{python d1_names, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
for tag in ___:
    print(___)
```
...
grade_this({
  ...
  if (is.null(student)) {
    ...
    incorrect("Make sure you are looping over `soup.find_all('h2')` and using `.get_text()`.")
  }
})
```
...
```{python d2_prices, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
price_pat = r"___"
...
```{python d3_sku, exercise=TRUE, message=FALSE, exercise.setup="d1_parse2"}
sku_pat = r"___"
products = ___
