...
ROW_CLUES <- list(
  list(clue="Row 1: starts with A, ends with S; 4th letter is H"),
  list(clue="Row 2: 7 letters; has MB in positions 3–4"),
  list(clue="Row 3: begins CAP; 4th letter is T or X; ends URE"),
  list(clue="Row 4: begins GROUP; 6th is B or P; ends Y"),
  list(clue="Row 5: begins TOKEN; 6th is S or X; ends X"),
  list(clue="Row 6: begins FLAG; 5th is S; 6th is R or E; ends E"),
  list(clue="Row 7: begins PAR; 4th is S or T; ends ERS")
)
