...
```{python VIF2, exercise = TRUE, message = FALSE, exercise.setup="setup2"}
...
```{python VIF3, exercise = TRUE, message = FALSE, exercise.setup="setup2"}
...
```{python col, exercise=TRUE, exercise.eval = FALSE, message = FALSE, exercise.setup="setup2"}
...
```{python dummy1, exercise = TRUE, message = FALSE, exercise.setup="setup2"}
...
```{python dummy2, exercise = TRUE, message = FALSE, exercise.setup="setup2"}
