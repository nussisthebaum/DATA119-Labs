...
msleep = pd.get_dummies(msleep, columns = ['conservation'], dtype = float, dummy_na = True, drop drop_first=True)

X = msleep.drop(columns=["vore","order","genus","name","rownames","bodywt"])
