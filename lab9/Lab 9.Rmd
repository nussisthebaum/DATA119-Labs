...
Next, I want to see if regularization works well on this dataset. Use 5-fold cross validation to choose the best value of $\alpha$ for LASSO and Ridge Regression. What is the overall training and testing MSE for each model? Which of these 3 models would you choose?
...
```{r q2, echo=FALSE}
question_checkbox(
  "More specifically, which model(s) should I use?",
