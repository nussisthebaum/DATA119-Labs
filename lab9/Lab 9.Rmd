...
for k in range(1, 16):
  ...
  metric_train.append((tempknn_cm_train.iloc[0,0] + tempknn_cm_train.iloc[1,1])/X_train.shape[0])
  metric_test.append((tempknn_cm_test.iloc[0,0] + tempknn_cm_test.iloc[1,1])/X_test.shape[0])
  
d_kNN = {
    'k': list(range(1, 16)) * 2,  # Expands range into a list and duplicates for both Train & Test
    'Accuracy': metric_train + metric_test,  # Concatenates both lists
    'Data': ['Train'] * 15 + ['Test'] * 15  # Creates a single correct list
}
